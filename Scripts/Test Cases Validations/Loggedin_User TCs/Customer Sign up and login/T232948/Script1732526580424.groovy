...
Mobile.setText(findTestObject('Check In screen elements/MobileNumber'), GlobalVariable.NotRegisteredEgyptian, 0)
...
if (actualErrorMessage.contains('not registered')) {
    WebUI.comment('Error message verification passed: Contains \'not registered\'' // Fail the test
        )
} else {
