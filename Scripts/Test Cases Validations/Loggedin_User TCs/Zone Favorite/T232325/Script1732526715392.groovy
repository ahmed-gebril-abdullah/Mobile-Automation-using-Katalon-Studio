...
Mobile.verifyElementText(findTestObject('My Favorites/ZoneHours'), GlobalVariable.ZoneHours)

String x = Mobile.getText(findTestObject('My Favorites/ZoneHours'), 0)

WebUI.comment('Retrieved text: ' + x)

Mobile.verifyEqual(x, GlobalVariable.ZoneHours, FailureHandling.CONTINUE_ON_FAILURE)
